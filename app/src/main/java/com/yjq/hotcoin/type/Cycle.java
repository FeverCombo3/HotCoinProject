...
public enum Cycle {
    ...
    CYCLE_1H("60min",4,"1小时"),
    CYCLE_4H("4h",5,"4小时"),//4小时的火币API没有，他自己的APP上却有，真的很神奇
    CYCLE_1DAY("1day",6,"1天"),
    CYCLE_1MON("1mon",7,"1月"),
    CYCLE_1WEEK("1week",8,"1周"),
    CYCLE_1YEAR("1year",9,"1年");//1年的火币API有，他自己的APP上却没有，也很神奇
