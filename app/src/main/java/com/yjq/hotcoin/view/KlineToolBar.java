...
public class KlineToolBar extends LinearLayout implements View.OnClickListener{
    ...
    private void init(Context context){
        ...
        if(PreferenceUtil.getInstance().getMainIndicator() == -1){
        ...
        if(PreferenceUtil.getInstance().getSubIndicator() == -1){
        ...
        for (final Indicator indicator : indicatorList){
            ...
            if(PreferenceUtil.getInstance().getSubIndicator() == indicator.getIndex() || PreferenceUtil.getInstance().getMainIndicator() == indicator.getIndex()){
            ...
            tv.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(indicator.getposition() == 1){ //主图指标
                        ...
                        tv.setTextColor(mContext.getResources().getColor(R.color.color_white));
                        PreferenceUtil.getInstance().setMainIndicator(indicator.getIndex());
                    }else {
                        clearSubContainerText();
                        mTvSubHide.setTextColor(mContext.getResources().getColor(R.color.kline_blue));
                        tv.setTextColor(mContext.getResources().getColor(R.color.color_white));
                        PreferenceUtil.getInstance().setSubIndicator(indicator.getIndex());
    ...
    private void handleCycleClick(View view){
        ...
        while (iterator.hasNext()){
            ...
            if(key == view.getId()){
                cycle.setTextColor(mContext.getResources().getColor(R.color.kline_blue_choose));
                indicator.setVisibility(VISIBLE);
                PreferenceUtil.getInstance().setKlineCycle(key);
                if (mListener != null){
    ...
    private void handleMoreCycleCLick(View v){
        ...
        mMoreContainer.setVisibility(GONE);
        chooseMoreCycle();
        PreferenceUtil.getInstance().setKlineCycle(v.getId());
        if(mListener != null){
